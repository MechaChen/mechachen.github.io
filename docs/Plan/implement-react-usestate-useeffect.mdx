---
sidebar_label: '[Implement] 40 行實現 React `useState`, `useEffect`'
title: '[Implement] 40 行實現 React `useState`, `useEffect`'
tags:
  - Implement
  - React
...
:::info 原始碼在這，歡迎參考～
https://github.com/MechaChen/useState-and-useEffect-lite
:::
