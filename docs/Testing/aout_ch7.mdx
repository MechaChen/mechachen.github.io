...
sidebar__label: '[Book] 單元測試的藝術：Ch7. Trustworthy'
title: '[Book] 單元測試的藝術：Ch7. Trustworthy'
...
當 class `LogAnalyzer` 的使用方法有變更，需要初始化（使用 `Initialize` method)，<br />
此時，我們就一定要更改測試
...
<br />
小技巧：<br />
我們可以用工廠模式處理初始化的部分，讓 call <code>Initialize</code> 不用寫在每個 test case 中，<br />
即遵守 DRY 原則
<br />
<br />
